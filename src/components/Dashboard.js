...
//         <h3 className='text-xl font-semibold'>An Overview</h3>
...
//             <button
//               className="flex w-[9rem] items-center justify-between bg-[#eee] py-3 px-4"
//               type="button"
...
//         </div>
//       </section>
//       <section className='px-10 flex flex-wrap gap-6 max-w-7xl mx-auto'>
//         {
//           cardData?.map((data) => (
...
//           <div className='relative'>
//             <button
//               className="flex w-full md:w-[9rem] items-center justify-between bg-[#eee] py-3 px-4"
//               type="button"
//               onClick={() => setOpen(!open)}
//             >
//               {item}
...
//         </div>
//       </section>
//       <section className='px-4 md:px-10 flex flex-wrap gap-6 max-w-7xl mx-auto'>
//         {cardData?.map((data) => (
//           <CardInfo key={data.date} cardInfo={data} />
//         ))}
//       </section>
...
const Dashboard = () => {
  ...
  return (
    <main className='py-8'>
      ...
      <section className='px-4 md:px-10 flex flex-wrap gap-5 max-w-7xl mx-auto md:w-[calc(33.33% - 2rem)]'>
        {cardData?.map((data) => (
          <CardInfo key={data.date} cardInfo={data} />
        ))}
      </section>
